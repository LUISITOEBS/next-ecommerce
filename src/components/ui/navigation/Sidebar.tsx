        ...
        <div className="">
            ...
            <nav className={
                ...
                <div className="relative mt-14">
                    ...
                    <input className="w-full bg-gray-50 rounded px-10 py-1 border-b-2 text-xl border-gray-200 focus:outline-none focus:border-blue-500" type="text" placeholder="Buscar" />
                </div>
